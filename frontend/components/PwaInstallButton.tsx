    ...
    return (
      <>
        <button
          ...
          title="Download FLUMENX App to your mobile phone or desktop"
        >
          <Smartphone size={16} />
        ...
        {showModal && <PwaInstructionsModal isIos={isIos} onClose={() => setShowModal(false)} />}
      </>
    );
  }
...
function PwaInstructionsModal({ isIos, onClose }: { isIos: boolean; onClose: () => void }) {
  return (
    <Modal title="Install FLUMENX App" onClose={onClose}>
      <div style={{ padding: "6px 0", color: "#18231F" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "18px" }}>
          ...
          <img
            src="/flumen-icon.png"
            alt="FLUMENX"
            style={{ width: "48px", height: "48px", borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}
          />
          <div>
            <h4 style={{ margin: 0, fontSize: "16px", fontWeight: 800 }}>FLUMENX Employee Portal</h4>
            <p style={{ margin: 0, fontSize: "12.5px", color: "#64748B" }}>Fast, offline-ready mobile web app</p>
          </div>
        </div>
