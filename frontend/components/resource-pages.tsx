export { EmployeeForm, EmployeesPage } from "@/features/employees/EmployeesPage";
export { LeavesPage } from "@/features/leaves/LeavesPage";
export { SalaryPage } from "@/features/salary/SalaryPage";
